...
const Side_menu_page = () => {
    ...
    return (
        ...
        <View style={{ flex: 10, marginRight: "10%",backgroundColor:"white" }}>
            <View style={{ flex: 3, backgroundColor: "#3399ff",elevation:5, justifyContent: 'center', alignItems: 'center',
        borderBottomEndRadius:1000 }}>
                
                
            </View>
            
            <View style={{ flex: 7, backgroundColor: "white",borderBottomEndRadius:1000, justifyContent: 'space-evenly' }}>
...
const styles = StyleSheet.create(
    {
        image_styles: {
            height: 30, width: 30, tintColor: "#3399ff", marginRight: 10
        },
        text_styles: {
